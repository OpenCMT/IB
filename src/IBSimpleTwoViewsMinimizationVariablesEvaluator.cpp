...
Vector4f IBSimpleTwoViewsMinimizationVariablesEvaluator::evaluateVariables()
{
    HVector3f disp;
...
Matrix4f IBSimpleTwoViewsMinimizationVariablesEvaluator::evaluateErrorMatrix()
{
    Matrix4f covariance;
...
HVector3f IBSimpleTwoViewsMinimizationVariablesEvaluator::getDirectorCosines(const HVector3f &track_direction)
{
    return track_direction / track_direction.head(3).norm();
}

void IBSimpleTwoViewsMinimizationVariablesEvaluator::projectionOnContainer(HPoint3f &in, HPoint3f &out)
{
